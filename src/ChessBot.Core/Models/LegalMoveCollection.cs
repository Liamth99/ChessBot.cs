...
public class LegalMoveCollection
{
    ...
    public IReadOnlyList<Move> FriendlyMoves => _friendlyMoves;
    public IReadOnlyList<Move> EnemyMoves => _enemyMoves;
    ...
    public long WhiteAttackBits { get; private set; }
    public long BlackAttackBits { get; private set; }
